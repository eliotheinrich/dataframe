...
namespace dataframe {
  ...
  void init_dataframe(nanobind::module_ &m) {
    ...
    nanobind::class_<DataFrame>(m, "DataFrame")
      ...
      .def("__add__", [](const DataFrame& self, const DataFrame& other) { return self.combine(other, true); })
      ...
      .def("combine", &DataFrame::combine, "other"_a, "average_congruent_slides"_a = true)
